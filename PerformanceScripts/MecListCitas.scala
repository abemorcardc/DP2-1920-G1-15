...
class MecListCitas extends Simulation {
	...
	val PacoScn = scenario("Paco").exec(Home.home, LoginPaco.login, CitasList.citasList)

	val LoloScn = scenario("Lolo").exec(Home.home, LoginLolo.login, CitasList.citasList)
