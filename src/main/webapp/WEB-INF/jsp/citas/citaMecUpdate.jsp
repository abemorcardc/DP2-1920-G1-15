        	...
        	<div class="form-group has-feedback">
	        	...
	        	<div class="form-group">
	              <petclinic:inputField label="Fecha cita" name="fechaCita" placeholder="dd/MM/yyyy HH:mm"
						pattern="^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}(\s)([0-2][0-9])(:)([0-5][0-9])$" required="true"
						title="Introduce una fecha en futuro: Ejemplo: 12/12/2021 10:30 " />
	              <petclinic:inputField label="Descripción" name="descripcion" required="true" />
	              <petclinic:inputField label="Tiempo" name="tiempo" required="true" pattern="^\\d{1,6}$" placeholder="Solo numeros"
						title="Ejemplo: 5" />
	              <petclinic:inputField label="Coste" name="coste" required="true" pattern="\d{1,3}.\d{0,2}" placeholder="Solo numeros"
						title="Ejemplo: 50.00" />
	              <div class="form-group">
